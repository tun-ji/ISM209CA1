...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:postgres@localhost:5440/airtelreg'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.secret_key=b"h\xdf\x88\x83\xe4'/\x83*X\xcc\xfa\xf7\x10\\R\xbc|D\xa0[,\n\x8f"
db = SQLAlchemy(app)
...
@app.route("/")
def index():
    return render_template('home.html', title="Airtel Website", informatiion="Welcome")


@app.route("/products-and-services")
def products():
    return render_template('products-and-services.html', title="Products and Services", information="View Products")
